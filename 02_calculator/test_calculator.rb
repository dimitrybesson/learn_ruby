...
# This one is a bit trickier!
  ...
  # Define new method 'product'
  def test_multiplies_two_numbers
    assert_equal 15, product(3, 5)
  end

  def test_multiplies_several_numbers
    assert_equal 60, product(2, 3, 10)
  end

  def test_multiples_with_zero
    assert_equal 0, product(5, 0, 4)
  end
...
# http://en.wikipedia.org/wiki/Factorial
  ...
  def test_computes_factorial_10
    assert_equal 3_628_800, factorial(10) #underscores are ignore
  end
end
